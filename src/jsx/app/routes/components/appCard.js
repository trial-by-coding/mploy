    ...
    <ModalBody>
      <Grid>
        ...
        <Row style={styles}>
          ...
          <row className='skills'>
            <h4 style={titles}> Applied on: </h4> {moment(this.props.app.created_at).format('LLLL')}
          </row>
        </Row>
        ...
        <Row style={styles}>
          ...
          <div style={styles}>
            <a href={this.props.app.resume} download={this.props.app.resume}>Download Resume</a>
            <br/>
